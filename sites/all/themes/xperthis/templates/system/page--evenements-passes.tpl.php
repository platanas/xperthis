  ...
  <div class="<?php print $container_class; ?>">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <div class="col-sm-2 no-padding">
          <a href="/<?php print $language->language; ?>/evenements" class="sliding-u-r-l"><?php print t('incoming'); ?></a>
      </div>
      <div class="col-sm-2 no-padding">
          <a href="/<?php print $language->language; ?>/evenements-passes" class="sliding-u-l-r active"><?php print t('past'); ?></a>
      </div>
