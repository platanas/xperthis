      ...
      <?php if ($block['collapsed']): ?>
        <li class="mmenu-collapsed">
          <?php if (!empty($block['subject'])): ?>
            <span class="mmenu-block-collapsed mmenu-block"><span class="mmenu-block-title"><?php print $block['subject']; ?></span></span>
          <?php endif; ?>
          <?php if($block['wrap']): ?>
      ...
      <?php else : ?>
        <?php if (!empty($block['subject'])): ?>
          <li class="mmenu-expanded">
            <span class="mmenu-block-expanded mmenu-block"><span class="mmenu-block-title"><?php print $block['subject']; ?></span></span>
          </li>
        <?php endif; ?>
        <?php if($block['wrap']): ?>
          <ul><li class="mmenu-block-wrap"><span><?php print $block['content']; ?></span></li></ul>
